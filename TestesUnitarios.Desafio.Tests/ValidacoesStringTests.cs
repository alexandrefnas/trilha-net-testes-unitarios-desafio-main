...
public class ValidacoesStringTests
{
    ...
    public void DeveRetornar6QuantidadeCaracteresDaPalavraMatrix()
    {
        ...
        // Arrange
        var texto = "Matrix"; //implementado
        var resultadoEsperado = 6; //implementado
    ...
    public void DeveContemAPalavraQualquerNoTexto()
    {
        ...
        // Act
        var resultado =  _validacoes.ContemCaractere(texto, textoProcurado); //implementado

        // Assert
        //TODO: Corrigir o Assert.True com base no retorno da chamada ao método
        Assert.True(resultado); //implementado
    }
    ...
    public void TextoDeveTerminarComAPalavraProcurado()
    {
        ...
        var textoProcurado = "procurado"; //implementado
